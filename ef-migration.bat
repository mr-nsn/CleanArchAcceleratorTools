...
dotnet ef migrations add %MIGRATION_NAME% --project src\examples\CleanArchAcceleratorTools.Examples
...
dotnet ef database update --project src\examples\CleanArchAcceleratorTools.Examples
